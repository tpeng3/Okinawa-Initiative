        ...
        <div>
            ...
            <div className="events-grid"> 
                ...
                <Card shadow={5} style={{minWidth: '450', height: '400px', margin: 'auto'}}>
                    ...
                    <a href="https://www.facebook.com/ucscOMI/" class="btn btn-primary" role="button" style={{position: 'absolute', bottom: '0', width: '100%'}}>Read More!</a>
            ...
            <div class="media">
                <div class="media-left">
                    <a href="#">
                        <img class="media-object" src="https://pbs.twimg.com/card_img/1071137009266094080/ajfJymE-?format=jpg&name=800x419" alt="..."/>
                    </a>
                </div>
                <div class="media-body">
                    ...
                    <a href="https://twitter.com/RyanYokota/status/1060968232469839872" class="btn btn-primary" role="button">Read More!</a>
                </div>
            </div>
