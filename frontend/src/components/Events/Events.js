        ...
        <div>
            ...
            <div className="events-grid"> 
                ...
                <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                    <CardTitle style={{color: '#fff', height: '176px', background: 'url(https://scontent-sjc3-1.xx.fbcdn.net/v/t1.0-9/46472489_985038954953876_889194861771620352_n.jpg?_nc_cat=105&_nc_ht=scontent-sjc3-1.xx&oh=c884d6177a28ce2afdf0b02ebe80149a&oe=5CAC6DD0) center / cover'}}>The Okinawa Memories Initiative</CardTitle>
                ...
                {/* Vault 2 */}
                <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                    <CardTitle style={{color: '#fff', height: '176px', background: 'url(https://scontent-sjc3-1.xx.fbcdn.net/v/t1.0-9/47068357_999198536871251_6775056681735815168_n.jpg?_nc_cat=105&_nc_ht=scontent-sjc3-1.xx&oh=29f75cfa916bd3b2b978b204470802a2&oe=5CB21CD4) center / cover'}}>The Okinawa Memories Initiative</CardTitle>
                ...
                {/* Vault 3 */}
                <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                    <CardTitle style={{color: '#fff', height: '176px', background: 'url(https://scontent-sjc3-1.xx.fbcdn.net/v/t1.0-9/44764883_960999057357866_1124210700500074496_n.jpg?_nc_cat=102&_nc_ht=scontent-sjc3-1.xx&oh=fc639a3f76447f9a712a68ec3b33542e&oe=5CA973D3) center / cover'}}>The Okinawa Memories Initiative</CardTitle>
