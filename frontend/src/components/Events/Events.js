        ...
        <div>
            ...
            <div className="events-grid"> 
                ...
                <Card shadow={5} style={{minWidth: '450', height: '400px', margin: 'auto'}}>
                    ...
                    <a href="https://www.facebook.com/ucscOMI/" className="btn btn-primary" role="button" style={{position: 'absolute', bottom: '0', width: '100%'}}>Read More!</a>
            ...
            <div className="media">
                <div className="media-left">
                    <a href="#">
                        <img className="media-object" src="https://pbs.twimg.com/card_img/1071137009266094080/ajfJymE-?format=jpg&name=800x419" alt="..."/>
                    </a>
                </div>
                <div className="media-body">
                    <h6 className="media-heading"><i>The Okinawa Memories Inititative</i> Retweeted</h6>
                    ...
                    <a href="https://twitter.com/RyanYokota/status/1060968232469839872" className="btn btn-primary" role="button">Read More!</a>
                </div>
            </div>
